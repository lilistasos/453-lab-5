...
public final class ItemDao_Impl implements ItemDao {
  ...
  @Override
  public Object getItemById(final int id, final Continuation<? super Item> $completion) {
    final String _sql = "SELECT * from items WHERE id = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, id);
  ...
  @Override
  public Object getItemByName(final String name, final Continuation<? super Item> $completion) {
    final String _sql = "SELECT * from items WHERE LOWER(name) LIKE LOWER(?) LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
